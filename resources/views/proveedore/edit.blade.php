...
@section('content')
    <div class="pagetitle">
        <h1 class="mt-4 text-center" style="font-size: 40px;">Editar Proveedor</h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="card rounded-4">
            <div class="card-body">
                ...
                <!--  -->
                <form action="{{route('proveedores.update',['proveedore' => $proveedore])}}" class="row g-3" method="POST">
                    @method('PATCH')
                    @csrf
                    <!--Tipo Persona-->
                    <div class="col-md-12">
                        <label for="tipo_persona" class="col-sm-2 col-form-label">Tipo Proveedor: <span class="fw-bolder">{{strtoupper($proveedore->persona->tipo_persona)}}</span></label>
                    </div>
