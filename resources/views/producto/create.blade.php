...
@section('content')
    <div class="pagetitle">
        <h1 class="mt-4 text-center" style="font-size: 40px;">Crear Productos</h1>
        <nav>
            <ol class="breadcrumb">
        ...
        <div class="card rounded-4">
            <div class="card-body">
                <h5 class="card-title">Formulario Productos</h5>
                ...
                <form action="{{ route('productos.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control" style="height: 100px">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                            <small class="text-danger">{{ '>:( ' . $message }}</small>
                            @enderror
                        </div>
