...
@section('content')
    ...
    <div class="pagetitle">
        <h1 class="mt-4 text-center" style="font-size: 40px;">Presentaciones</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <div class="card rounded-4">
        ...
        <div class="card-body">
            <h5 class="card-title">Tabla Presentaciones <span>| Hoy</span></h5>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        {{ $item->caracteristica->estado == 1 ? '¿Desea eliminar esta Categoria?' : '¿Desea restaurar esta Categoria?' }}
                                    </div>
